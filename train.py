...
def main():
    ...
    num_heads = 24          # Number of attention heads in a single encoder
    ...
    mean= [0.41433686 0.41618344 0.4186155 ], 
    std= [0.1953987  0.19625916 0.19745596]
    ...
    train_data = Custom_Traffic_Dataset(tube_d, size, n_channels, "/data/ryan_thesis_ds/thesis_videos", '/data/ryan_thesis_ds/crash_frame_numbers.txt', mean, std)
